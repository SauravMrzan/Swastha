...
const AdminDashboard = () => {
  ...
  const handleFileChange = (e) => {
    setNewDoctor({ ...newDoctor, profileImg: URL.createObjectURL(e.target.files[0]) });
  };
  ...
  return (
    <div className="admin-container">
      <nav className="admin-nav">
        ...
        <button onClick={() => setActiveTab('addDoctor')} className={activeTab === 'addDoctor' ? 'active' : ''}>
          Add Doctor
        </button>
        <button onClick={() => setActiveTab('doctorList')} className={activeTab === 'doctorList' ? 'active' : ''}>
          Doctors List
        </button>
      </nav>
                ...
                {appointments.map(appt => (
                  <tr key={appt.id}>
                    ...
                    <td>
                      {appt.status === 'pending' && (
                        <>
                          <button onClick={() => handleAppointmentStatus(appt.id, 'accepted')} className="accept">
                            Accept
                          </button>
                          <button onClick={() => handleAppointmentStatus(appt.id, 'rejected')} className="reject">
                            Reject
                          </button>
                        </>
                      )}
            ...
            <form onSubmit={handleAddDoctor}>
              <div className="form-group">
                ...
                {newDoctor.profileImg && (
                  <img src={newDoctor.profileImg} alt="Preview" className="profile-preview" />
                )}
              </div>
              
              <div className="form-group">
                <label>Full Name</label>
                <input type="text" value={newDoctor.name} 
              ...
              <div className="form-group">
                ...
                <input type="text" value={newDoctor.specialty} 
              ...
              <div className="form-group">
                <label>Email</label>
                <input type="email" value={newDoctor.email} 
              ...
              <div className="form-group">
                <label>Address</label>
                <input type="text" value={newDoctor.address} 
              ...
              <div className="form-group">
                ...
                <input type="text" value={newDoctor.experience} 
              ...
              <div className="form-group">
                ...
                <input type="text" value={newDoctor.fee} 
              ...
              <div className="form-group">
                ...
                <textarea value={newDoctor.description} 
              ...
              <div className="doctor-grid">
                {doctors.map(doctor => (
                  <div className="doctor-card" key={doctor.id}>
                    {doctor.profileImg && (
                      <img src={doctor.profileImg} alt={doctor.name} className="doctor-image" />
                    )}
                    <h3>{doctor.name}</h3>
